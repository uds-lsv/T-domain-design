...
class ESM3LM():
    """ESM3 protein language model wrapper for embeddings and scoring.
    
    Example:
        model = ESM3LM(device='gpu')
    """
    ...
    def get_prob(self, sequence):
        ...
        Returns:
            Numpy array of probabilities (seq_len, 33) - ESM3 outputs 64 tokens but only 33 used
        """
